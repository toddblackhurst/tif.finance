...
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    .from("expenses")
    .select(`
      expense_date, serial_number, description, category, amount, payment_method, status,
  ...
  type Row = {
    expense_date: string; serial_number: string | null; description: string; category: string;
