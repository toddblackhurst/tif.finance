  ...
  return (
    <form action={formAction} className="space-y-6 max-w-2xl">
      ...
      <div className="space-y-1.5">
        <Label>{t("donor")}</Label>
        <DonorSearch
          value={initialValues?.donor_id ?? null}
          onChange={() => {}}
          initialDonorId={initialValues?.donor_id}
          initialDonorName={initialValues?.donor_name}
        />
      ...
      <div className="space-y-1.5">
        ...
        <Input
          id="gift_date" name="gift_date" type="date" required
          defaultValue={initialValues?.gift_date ?? new Date().toISOString().slice(0, 10)}
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <select id="fund_id" name="fund_id" required
          defaultValue={initialValues?.fund_id ?? ""}
          className="flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-ring">
          <option value="">—</option>
      ...
      <div className="space-y-1.5">
        ...
        <Input id="deposit_reference" name="deposit_reference"
          placeholder="e.g. deposit slip #, cheque #"
          defaultValue={initialValues?.deposit_reference ?? ""}
        />
      </div>
